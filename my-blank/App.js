...
const MAX_RESULTS = 120; // Máximo libros a traer por categoría
const PAGE_SIZE = 40;    // Máximo por consulta permitido por Google Books API
...
const App = () => {
  ...
  const groupBooksByAuthor = (books) => {
    ...
    // Filtro para autores con al menos 2 libros para evitar muchos autores con 1 solo libro (puedes cambiar a 1 si quieres)
